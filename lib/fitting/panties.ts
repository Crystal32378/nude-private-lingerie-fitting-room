...
export const PANTIES: PantyRecord[] = [
  {
    ...base("basic-seamless-panty"), id: "panty-01", nameZh: "NUDE超完美無痕內褲",
  ...
  {
    ...base("fashion-seamless-panty"), id: "panty-02", nameZh: "NUDE魔幻時尚無痕內褲",
  ...
  {
    ...base("fashion-mesh-panty"), id: "panty-03", nameZh: "NUDE心機透視內褲",
  ...
  {
    ...base("lace-bikini"), id: "panty-04", nameZh: "NUDE天使蕾絲內褲",
  ...
  {
    ...base("chiffon-lace-panty"), id: "panty-05", nameZh: "NUDE雪紡蕾絲透視內褲",
  ...
  {
    ...base("nude-plus-ultimate-bikini-panty"), id: "panty-06", nameZh: "NUDE極緻美型內褲",
  ...
  {
    ...base("floral-sheer-panty"), id: "panty-07", nameZh: "NUDE絕美雕花透膚褲",
  ...
  {
    ...base("bodyslim-highwaist-panty"), id: "panty-08", nameZh: "NUDE超激塑高腰纖體褲",
